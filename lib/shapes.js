...
class Triangle extends Shape{
    ...
    render(){
        return `<svg width="300" height="200"><g><polygon points="150, 18 244, 182 56, 182" fill="${this.color}" /><text font-size="70" fill="${this.textColor}" x="150" y="150" text-anchor="middle">${this.text}</text></g></svg>`
    }
}
